...
const Footer = () => {
	return (
		<footer>
			<section className="footer p-10 bg-primary text-primary-content">
				<div>
			...
			<section className="footer bg-secondary text-secondary-content px-10 py-4 border-t border-neutral-focus">
